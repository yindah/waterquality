...
def predict():
    ...
    if output == '2A':
        return render_template('main.html', result = 'The water quality need a conventional treatment.')
							   
    elif output == '2B':
        return render_template('main.html', result = 'The water quality is a recreational use for body context.')
		
    elif output == '3':
        return render_template ('main.html', result = 'The water quality need an extensive treatment.')
		
    else:
        return render_template('main.html', result = 'The water quality could not be detected.')
